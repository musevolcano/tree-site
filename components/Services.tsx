...
export default function Services() {
  return (
    ...
    >
      {/* Green overlay — Forest Emerald, lighter at top so hero bleeds in */}
      <div
        className="absolute inset-0"
        style={{
          background:
            "linear-gradient(to bottom, rgba(22,101,52,0.60) 0%, rgba(22,101,52,0.85) 12%, rgba(22,101,52,0.88) 100%)",
        }}
      />

      {/* ── Left branch silhouette — flows from hero photo into services ─── */}
      <svg
        aria-hidden="true"
      ...
      >
        <g
          ...
          opacity="0.70"
        >
          {/* Main trunk — left edge, drifts inward */}
          <path strokeWidth="5"  d="M0,0 C18,35 28,90 22,170 C16,250 12,330 18,420"/>
          <path strokeWidth="2.5" d="M18,120 C14,155 13,195 18,240"/>

          {/* Top horizontal limb sweeping right */}
          <path strokeWidth="4"  d="M6,28 C45,18 110,8 185,6 C225,5 255,12 282,20"/>
          {/* Twigs off top limb */}
          <path strokeWidth="1.8" d="M55,14 C58,2 60,-6 62,-14"/>
          <path strokeWidth="1.5" d="M90,10 C93,-2 95,-10 97,-18"/>
          <path strokeWidth="1.8" d="M130,8  C134,-4 137,-12 139,-18"/>
          <path strokeWidth="1.5" d="M168,7  C173,-5 176,-13 179,-19"/>
          <path strokeWidth="1.3" d="M210,10 C216,0  219,-7  222,-13"/>
          <path strokeWidth="1.2" d="M248,17 C253,8  256,2  259,-3"/>
          {/* Fork off top limb */}
          <path strokeWidth="2.2" d="M100,9 C115,20 125,38 122,58"/>
          <path strokeWidth="1.4" d="M122,42 C128,35 133,30 137,26"/>

          {/* Second limb — mid sweep */}
          <path strokeWidth="3.5" d="M14,80 C55,66 120,54 195,50 C230,48 258,53 282,60"/>
          {/* Twigs off mid limb */}
          <path strokeWidth="1.8" d="M60,57 C64,44 67,34 69,26"/>
          <path strokeWidth="1.5" d="M100,53 C104,40 107,30 109,22"/>
          <path strokeWidth="1.8" d="M145,51 C150,37 153,27 155,18"/>
          <path strokeWidth="1.5" d="M185,51 C190,38 193,28 196,20"/>
          <path strokeWidth="1.3" d="M225,54 C230,43 233,35 236,28"/>
          {/* Drooping secondary off mid limb */}
          <path strokeWidth="2"   d="M80,55 C85,70 82,88 78,108"/>
          <path strokeWidth="1.4" d="M78,85 C72,90 66,92 60,90"/>
          <path strokeWidth="1.3" d="M78,100 C83,105 86,110 87,116"/>

          {/* Third limb — lower, shorter reach */}
          <path strokeWidth="3"   d="M18,155 C52,142 110,130 170,126"/>
          {/* Twigs off lower limb */}
          <path strokeWidth="1.8" d="M65,132 C69,118 72,108 74,100"/>
          <path strokeWidth="1.5" d="M105,129 C109,115 112,105 114,97"/>
          <path strokeWidth="1.5" d="M145,127 C149,113 152,103 154,95"/>
          {/* Drooping from lower limb */}
          <path strokeWidth="1.8" d="M90,130 C93,145 90,162 85,180"/>
          <path strokeWidth="1.3" d="M85,158 C79,164 72,166 65,163"/>

          {/* Bottom trailing branch */}
          <path strokeWidth="2.5" d="M18,240 C40,232 72,222 108,218"/>
          <path strokeWidth="1.5" d="M55,220 C59,207 62,197 64,189"/>
          <path strokeWidth="1.3" d="M85,219 C89,206 92,196 94,188"/>

          {/* Lowest edge wisps */}
          <path strokeWidth="2"   d="M18,330 C32,325 50,318 72,315"/>
          <path strokeWidth="1.3" d="M40,316 C44,304 47,295 49,288"/>

          {/* Hanging droop off trunk at mid */}
          <path strokeWidth="1.8" d="M20,190 C28,205 26,222 20,238"/>
          <path strokeWidth="1.3" d="M20,218 C14,224 8,226 2,223"/>
        </g>
      </svg>

      {/* ── Right branch silhouette — mirror of left ─────────────────────── */}
      <svg
        aria-hidden="true"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 280 440"
